...
def login():
    ...
    elif usernameEntry.get()=='Nikhil' and passwordEntry.get()=='1234':
...
logoImage = PhotoImage(file='img_4.png')

logoLabel = Label(loginFrame,image=logoImage)
logoLabel.grid(row=0,column=0,columnspan=2,pady=10)
usernameImage = PhotoImage(file='img_3.png')
...
passwordImage = PhotoImage(file='img_5.png')
